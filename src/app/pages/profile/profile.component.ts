...
@Component({
  ...
  template: `
    <div class="relative overflow-x-hidden">
      <div
        class="fixed top-0 left-0 w-screen h-screen bg-gradient-to-r from-verdeClaro to-verdeClaro -z-10"
        style="clipPath: polygon(0 0, 100% 0, 100% 30%, 0 80%)"
      ></div>
      <app-header [navLinks]="navLinks" />

      <!-- Mobile: centralized top section -->
      <div class="md:hidden flex flex-col items-center pt-20 px-4">
        <h1 class="font-bold text-3xl text-black">GERENCIAMENTO</h1>
        <h1 class="font-bold text-3xl text-black mt-[-4px]">DE CONTA</h1>
        <p class="text-sm text-black mt-4 text-center">
          Preencha ou edite os campos abaixo e salve as alterações para manter seu perfil
          atualizado.
        </p>
        <div class="mt-6 relative">
          @if (fotoUrl) {
            <img
              [src]="fotoUrl"
              alt="Foto do usuário"
              class="rounded-full w-[110px] h-[110px] object-cover cursor-pointer"
              (click)="fileInput.click()"
            />
          } @else {
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="rounded-full bg-blue-100 cursor-pointer w-[110px] h-[110px]"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              stroke-width="1"
          ...
          <div
            class="absolute ml-[62px] mt-[-25px] w-10 h-10 bg-amber-50 z-20 rounded-full flex items-center justify-center cursor-pointer"
            (click)="fileInput.click()"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="text-emerald-800 w-7 h-7"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              stroke-width="3.5"
      ...
      <div class="w-full flex">
        <!-- Desktop: fixed left section -->
        <div
          class="hidden md:flex flex-col items-start justify-center w-1/3 h-full z-20 pl-30 mt-25"
        >
          <div class="mt-15 fixed z-9 text-white">
          ...
          <div class="fixed flex flex-col items-start justify-center z-20 ml-18 mt-110">
            @if (fotoUrl) {
              <img
                [src]="fotoUrl"
                alt="Foto do usuário"
                class="relative rounded-full w-[110px] h-[110px] object-cover cursor-pointer"
                (click)="fileInputDesk.click()"
              />
            } @else {
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="relative rounded-full bg-blue-100 cursor-pointer w-[110px] h-[110px]"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                stroke-width="1"
            ...
            <div
              class="relative ml-[62px] mt-[-25px] w-10 h-10 bg-amber-50 z-20 rounded-full flex items-center justify-center cursor-pointer"
              (click)="fileInputDesk.click()"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <!-- Cards - Mobile -->
        <div class="md:hidden flex flex-col items-center pt-4 px-4">

          <!-- Card 1: Informações Pessoais -->
          <div class="w-full mt-6 rounded-xl overflow-hidden flex flex-col shadow-[5px_5px_4px_rgba(0,0,0,0.25)]">
            <div class="w-full bg-gray-200 p-4">
              <div class="text-emerald-800">
                <h1 class="font-bold text-xl leading-none">Informações Pessoais</h1>
              </div>
              <div class="text-black mt-2">
                <p class="text-xs leading-none">Essa informação é particular e não será compartilhada com outras pessoas.</p>
              </div>
            </div>
            <div class="w-full bg-gray-50 p-4">
              <div class="flex flex-col items-start justify-center gap-3">
                <div class="w-full h-12 rounded-lg overflow-hidden flex">
                  <div class="w-full bg-gray-200">
                    <div class="text-gray-400 ml-2 mt-1">
                      <h1 class="font-bold text-[70%] leading-none">NOME:</h1>
                    </div>
                    <input id="nome-m" type="text" class="ml-2 w-full" [(ngModel)]="nome" />
                  </div>
                </div>
                <div class="w-full h-12 rounded-lg overflow-hidden flex">
                  <div class="w-full bg-gray-200">
                    ...
                    <input id="data-m" type="date" class="ml-2 w-full" [(ngModel)]="dataNascimento" />
                  </div>
                </div>
                <div class="w-full h-12 rounded-lg overflow-hidden flex">
                  <div class="w-full bg-gray-200">
                    ...
                    <input id="cidade-m" type="text" class="ml-2 w-full" [(ngModel)]="cidadeEstado" />
                  </div>
                </div>
                <div class="w-full h-12 rounded-lg overflow-hidden flex">
                  <div class="w-full bg-gray-200">
                    ...
                    <input id="email-m" type="text" class="ml-2 w-full" [(ngModel)]="email" />
                  </div>
                </div>
                <div class="w-full h-8 mt-2 rounded-xl overflow-hidden flex cursor-pointer" (click)="salvarInformacoesPessoais()">
          ...
          <div class="w-full mt-6 mb-10 rounded-xl overflow-hidden flex flex-col shadow-[5px_5px_4px_rgba(0,0,0,0.25)]">
            <div class="w-full bg-gray-200 p-4">
              <div class="text-emerald-800">
                <h1 class="font-bold text-xl leading-none">Informações Complementares</h1>
              </div>
              <div class="text-black mt-2">
                <p class="text-xs leading-none">Essa informação é particular e não será compartilhada com outras pessoas.</p>
              </div>
              ...
              <div class="flex flex-col items-start justify-center gap-3">
                <div class="w-full h-12 rounded-lg overflow-hidden flex">
                  <div class="w-full bg-gray-200">
                    ...
                    <input id="telefone-m" type="text" class="ml-2 w-full" [(ngModel)]="telefone" />
                  </div>
                </div>
                <div class="w-full h-12 rounded-lg overflow-hidden flex">
                  <div class="w-full bg-gray-200">
                    ...
                    <input id="numero-m" type="text" class="ml-2 w-full" [(ngModel)]="numero" />
                  </div>
                </div>
                <div class="w-full h-12 rounded-lg overflow-hidden flex">
                  <div class="w-full bg-gray-200">
                    ...
                    <input id="rua-m" type="text" class="ml-2 w-full" [(ngModel)]="rua" />
                  </div>
                </div>
                <div class="w-full h-12 rounded-lg overflow-hidden flex">
                  <div class="w-full bg-gray-200">
                    ...
                    <input id="complemento-m" type="text" class="ml-2 w-full" [(ngModel)]="complemento" />
                  </div>
                </div>
                <div class="w-full h-8 mt-2 rounded-xl overflow-hidden flex cursor-pointer" (click)="salvarInformacoesComplementares()">
                  <div class="w-full bg-emerald-700 flex items-center justify-center">
                    <h1 class="font-bold text-[70%] leading-none text-white">SALVAR ALTERAÇÕES</h1>
                  </div>
                </div>
          ...
          <!-- Card 3: Segurança e privacidade - Mobile -->
          <div class="w-full mb-10 rounded-xl overflow-hidden flex flex-col shadow-[5px_5px_4px_rgba(0,0,0,0.25)]">
            <div class="w-full bg-gray-200 p-4">
              <div class="text-emerald-800">
                <h1 class="font-bold text-xl leading-none">Segurança e privacidade</h1>
              </div>
              <div class="text-black mt-2">
                <p class="text-xs leading-none">Essa informação é particular e não será compartilhada com outras pessoas.</p>
              </div>
              ...
              <div class="flex flex-col items-start justify-center gap-3">
                <div class="w-full h-12 rounded-lg overflow-hidden flex">
                  <div class="w-full bg-gray-200">
                    ...
                    <input id="id-m" type="text" class="ml-2 w-full" [value]="usuarioId" readonly />
                  </div>
                </div>
                <div class="w-full h-12 rounded-lg overflow-hidden flex">
                  <div class="w-full bg-gray-200">
                    ...
                    <input id="novaSenha-m" type="password" class="ml-2 w-full" [(ngModel)]="novaSenha" />
                  </div>
                </div>
                <div class="w-full h-12 rounded-lg overflow-hidden flex">
                  <div class="w-full bg-gray-200">
                    ...
                    <input id="senhaAtual-m" type="password" class="ml-2 w-full" [(ngModel)]="senhaAtual" />
                  </div>
                </div>
                <div class="w-full h-12 rounded-lg overflow-hidden flex">
                  <div class="w-full bg-gray-200">
                    ...
                    <input id="senhaConfirmar-m" type="password" class="ml-2 w-full" [(ngModel)]="senhaConfirmar" />
                  </div>
                </div>
                <div class="w-full h-8 mt-2 rounded-xl overflow-hidden flex cursor-pointer" (click)="salvarSenha()">
                  <div class="w-full bg-emerald-700 flex items-center justify-center">
                    <h1 class="font-bold text-[70%] leading-none text-white">SALVAR ALTERAÇÕES</h1>
                  </div>
                </div>
          ...
          <!-- Card 4: Excluir conta - Mobile -->
          <div class="w-full mb-10 rounded-xl overflow-hidden shadow-[5px_5px_4px_rgba(0,0,0,0.25)]">
            <div class="bg-red-50 border border-red-200 rounded-xl p-6">
              <h2 class="text-red-600 font-bold text-lg mb-2">Excluir conta</h2>
              <p class="text-red-500 text-sm mb-6">Ao excluir sua conta, todos os seus dados serão removidos permanentemente. Esta ação não pode ser desfeita.</p>
              @if (!confirmarExclusao) {
                <button class="bg-red-600 text-white px-6 py-2 rounded-lg font-bold text-sm cursor-pointer hover:bg-red-700" (click)="confirmarExclusao = true">
                  EXCLUIR CONTA
                </button>
              } @else {
                <div class="flex flex-col gap-3">
                  ...
                  <div class="flex gap-3">
                    <button class="bg-red-600 text-white px-6 py-2 rounded-lg font-bold text-sm cursor-pointer hover:bg-red-700" (click)="excluirConta()">
                      SIM, EXCLUIR
                    </button>
                    <button class="bg-gray-300 text-gray-700 px-6 py-2 rounded-lg font-bold text-sm cursor-pointer hover:bg-gray-400" (click)="confirmarExclusao = false">
                      CANCELAR
                    </button>
                  </div>
                </div>
        ...
        <!-- Cards - Desktop -->
        <div class="hidden md:flex flex-col items-start justify-center pt-20">
          ...
          <div
            class="w-220 mb-10 rounded-xl overflow-hidden shadow-[5px_5px_4px_rgba(0,0,0,0.25)]"
          >
            <div class="bg-red-50 border border-red-200 rounded-xl p-6">
              <h2 class="text-red-600 font-bold text-lg mb-2">Excluir conta</h2>
...
export class ProfileComponent {
  ...
  @ViewChild('fileInputDesk') fileInputDesk!: ElementRef<HTMLInputElement>;
