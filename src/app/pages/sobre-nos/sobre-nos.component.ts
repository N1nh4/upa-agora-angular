    ...
    <section class="pt-16">
      ...
      <div class="w-11/12 h-auto mt-16 md:mt-32 mx-auto flex flex-col md:flex-row gap-8">
        <div class="w-full md:w-1/2 p-4">
          <div class="w-full pt-0 md:pt-10">
            <h1 class="text-2xl md:text-3xl font-bold text-[#15553C] text-center md:text-left">Quem Somos</h1>
            <p class="pt-6 md:pt-10 text-justify text-[#35644B]">
              ...
              para decisões mais conscientes e informadas dos usuários.
            </p>
            <div class="flex flex-wrap mt-6 md:mt-10 gap-2 justify-center md:justify-start">
              <span class="bg-[#00995D]/20 font-bold px-4 py-1 rounded-full text-sm">Transparência</span>
              <span class="bg-[#5CDCAA]/80 font-bold px-4 py-1 rounded-full text-sm">Saúde Pública</span>
              <span class="bg-[#00995D]/20 font-bold px-4 py-1 rounded-full text-sm">Cidadania Digital</span>
              <span class="bg-[#46E663]/40 font-bold px-4 py-1 rounded-full text-sm">Tecnologia Colaborativa</span>
              <span class="bg-[#00995D]/40 font-bold px-4 py-1 rounded-full text-sm">Inteligência Coletiva</span>
              <span class="bg-[#00995D]/20 font-bold px-4 py-1 rounded-full text-sm">Acesso a informação</span>
            </div>
          </div>
        </div>
        <div class="w-full md:w-1/2 p-4">
      ...
      <div class="w-11/12 h-auto mx-auto flex flex-col-reverse md:flex-row gap-8">
        ...
        <div class="w-full md:w-3/5 p-4">
          <div class="w-full">
            <h1 class="text-2xl md:text-3xl font-bold text-center text-[#15553C]">Sobre o Projeto</h1>
      ...
      <div class="w-11/12 h-auto mb-20 md:mb-40 mx-auto flex flex-col md:flex-row gap-8">
        <div class="w-full md:w-3/5 p-4">
          <div class="w-full">
            <h1 class="text-2xl md:text-3xl font-bold text-[#15553C]">Onde Atuamos</h1>
            <p class="pt-5 md:pt-7 text-justify text-[#35644B]">
            ...
            <p class="pt-5 text-justify text-[#35644B]">
              Acreditamos no poder da colaboração e da participação cidadã. Com o engajamento da comunidade,
              pretendemos expandir para outras cidades e estados do Brasil.
            </p>
          </div>
        </div>
        <div class="w-full md:w-2/5 p-4">
      ...
      <div class="w-11/12 h-auto mx-auto mb-10">
        <h1 class="text-3xl md:text-4xl font-bold text-center text-[#15553C]">VALORES</h1>
        <div class="w-full mt-6 flex flex-col gap-6 items-center">
          <div class="flex flex-col md:flex-row justify-center gap-6 md:gap-10 text-center text-[#35644B]">
          ...
          <div class="flex flex-col md:flex-row justify-center gap-6 md:gap-10 text-center text-[#35644B]">
            ...
            <div><h2 class="text-xl md:text-2xl font-semibold">Cidadania Digital</h2><p>Participação ativa e consciente.</p></div>
          </div>
        </div>
      </div>
    </section>
