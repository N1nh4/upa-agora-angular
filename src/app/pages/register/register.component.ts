  ...
  template: `
    <div class="relative min-h-screen overflow-hidden">
      ...
      <div class="flex items-center justify-center min-h-screen p-4">
        ...
        <div class="space-y-4">
          <div class="relative">
            <input type="text" placeholder="Nome completo" [value]="nome" (input)="nome = $any($event.target).value"
              class="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-700" />
          ...
          <div class="relative">
            <input type="email" placeholder="Digite seu email" [value]="email" (input)="email = $any($event.target).value"
          ...
          <div class="relative">
            <input type="password" placeholder="************" [value]="senha" (input)="senha = $any($event.target).value"
              class="w-full pl-12 pr-10 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-700" />
            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          ...
          <button (click)="criarConta()" class="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 px-4 rounded-lg transition duration-300 cursor-pointer">
            Cadastrar
          </button>
          ...
          <p class="text-gray-600 mt-6 text-sm">
            Já possui conta?
            <a routerLink="/entrar" class="text-emerald-600 hover:underline font-semibold">Entre aqui</a>
          </p>
        </div>
      </div>
    </div>
